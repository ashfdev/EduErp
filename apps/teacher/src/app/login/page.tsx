  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm rounded-lg border bg-white p-6 shadow-sm">
        <h1 className="mb-1 text-xl font-semibold" style={{ color: "var(--primary, #1a3c4a)" }}>Teacher Portal</h1>
        <p className="mb-6 text-sm text-gray-500">Sign in with your phone number or email.</p>
