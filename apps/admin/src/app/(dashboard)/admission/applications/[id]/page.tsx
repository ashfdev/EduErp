          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <MultiSelectChecklist
                ...
                emptyLabel="No Development/Library/Tuition/etc. fee structures are configured for this class yet — set them up under Fees → Fee Structures, then reopen this dialog."
              />
