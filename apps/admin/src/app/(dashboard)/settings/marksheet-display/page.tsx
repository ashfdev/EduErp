...
const GROUPS: { title: string; fields: { key: keyof MarksheetDisplaySettingsInput; label: string }[] }[] = [
  {
    ...
    fields: [
      ...
      { key: "show_attendance_info", label: "Show attendance info (Report Card only)" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "show_average_position", label: "Show average position" },
      { key: "show_average_remarks", label: "Show average remarks" },
    ],
  },
];
