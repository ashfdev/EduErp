...
export default function NewStudentPage() {
  ...
  // Only auto-check a fee the FIRST time it's ever seen -- re-running
  // setSelectedFeeIds(enrollmentFees.map(...)) on every refetch (e.g. the
  // list refetches whenever the Group changes) would silently re-check
  // anything the admin had deliberately unchecked, the instant the list
  // refreshed for any reason.
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {form.current_class_id && form.academic_year_id && (
                <div className="col-span-2 space-y-1.5">
                  ...
                  <p className="text-xs text-muted-foreground">Admission Fee, Development, Library, first month&apos;s Tuition, etc. — whatever is configured for this class under Fees → Fee Structures. Uncheck anything you don&apos;t want to charge right now.</p>
                  <MultiSelectChecklist
                    ...
                    emptyLabel="No fee structures are configured for this class yet — set them up under Fees → Fee Structures, then come back here."
                  />
